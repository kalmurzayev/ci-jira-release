...
#usage          :python ci_request_jira_tasks.py JIRA_HOST JIRA_ID JIRA_PWD (resolved/unresolved/all) AMIOS-1 AMAPI-2 ...
#===================================================================
...
# ------------------------- AlfaMobile Jira project constant values --------------------------
...
resolution_flag_arg = sys.argv[4]
...
for jira_key_arg in jira_key_arg_strings:
    ...
    if resolution_flag_arg == jira_issue_resolution_flag_unresolved and task_res_flag == True:
        continue
    if resolution_flag_arg == jira_issue_resolution_flag_resolved and task_res_flag == False:
        continue

    task_string = jira_key_arg + ': ' + jira_name_type_resolution[1]
